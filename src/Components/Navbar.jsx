     ...
     ${
       isActive
        ...
        <div
          ...
          bg-gradient-to-b from-amber-900 via-amber-900 to-amber-800
          shadow-2xl border-t border-amber-700/30
              ...
              {navItems.map((item, index) => {
                ...
                return (
                  <NavLink
                    ...
                    onClick={() => handleNavClick(item.path)}
                    className={({ isActive }) =>
                      `group w-full flex items-center gap-3 px-6 py-4 rounded-xl font-medium
     transition-all duration-300 ease-out focus:outline-none transform hover:translate-x-2
     ${
       isActive
